...
- [ ] GEO AI Citation Scraper & Monitor (`lib/geo/citation-tracker.ts`)
- [ ] LLM-Optimized Schema Injector (`lib/geo/llm-schema.ts`)
- [ ] GEO Visibility Analytics Widget (`components/dashboard/geo-card.tsx`)
