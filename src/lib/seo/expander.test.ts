...
describe("SEO expander", () => {
  it("generates valid sitemap XML", () => {
    const xml = generateSitemapEntries("https://xoopa.app", [
    ...
    expect(xml).toContain("https://xoopa.app/changelog/v1-release");
    expect(xml).toContain("https://xoopa.app/changelog/v2-update");
