...
describe("SEO expander", () => {
  it("generates valid sitemap XML", () => {
    const xml = generateSitemapEntries("https://vibelaunch.app", [
    ...
    expect(xml).toContain("https://vibelaunch.app/changelog/v1-release");
    expect(xml).toContain("https://vibelaunch.app/changelog/v2-update");
